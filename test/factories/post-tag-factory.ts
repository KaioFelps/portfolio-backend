...
export class PostTagFactory {
  ...
  static exec(override?: Optional<PostTagProps, "postId" | "tag">, id?: EntityUniqueId) {
  ...
  async createAndPersist(override?: Optional<PostTagProps, "postId" | "tag">, id?: EntityUniqueId) {
