...
type DeletePostServiceResponse = Either<UnauthorizedError | ForbiddenError, object>;
...
export class DeletePostService {
  ...
  async exec({ authorId, postId }: DeletePostServiceRequest): Promise<DeletePostServiceResponse> {
