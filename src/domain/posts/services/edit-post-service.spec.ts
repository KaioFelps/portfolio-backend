...
describe("Edit Post Service", () => {
  ...
  beforeEach(async () => {
    ...
    sut = new EditPostService(tagsRepository, postsRepository, usersRepository, postTagsRepository);
  });
  ...
  it("should edit a post", async () => {
    ...
    expect(postsRepository.items[0].tags.getItems()[0].tag.id.toValue()).toBe(tag.id.toValue());
