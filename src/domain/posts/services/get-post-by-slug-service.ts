...
type GetPostBySlugServiceResponse = Either<null, { post: PostWithAuthor | null }>;

@Injectable()
export class GetPostBySlugService {
  constructor(private postsRepository: IPostsRepository) {}

  async exec({ slug, user }: GetPostBySlugServiceRequest): Promise<GetPostBySlugServiceResponse> {
