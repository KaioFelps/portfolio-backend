...
export abstract class IPostsRepository {
  ...
  abstract findMany(params: PostListPaginationParams): Promise<PaginationResponse<Post>>;

  abstract findManyPublished(params: PostListPaginationParams): Promise<PaginationResponse<Post>>;
