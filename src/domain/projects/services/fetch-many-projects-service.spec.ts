  ...
  beforeAll(async () => {
    ...
    const projectWithTags1And2 = ProjectFactory.exec({
      tags: new ProjectTagList([
        ProjectTag.create({ projectId: project1Tags1And2Id, tag: tag1 }, new EntityUniqueId("1")),
        ProjectTag.create({ projectId: project1Tags1And2Id, tag: tag2 }, new EntityUniqueId("2")),
      ]),
      title: "teste 1",
    });
    ...
    projectsRepository.items.push(ProjectFactory.exec({ title: "design de fs" }));
