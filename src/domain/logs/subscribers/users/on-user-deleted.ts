...
export class OnUserDeleted implements EventHandler {
  ...
  public setupSubscriptions(): void {
    DomainEvents.registerAggregateEvent(this.createLog.bind(this), UserDeletedEvent.name);
  }

  private async createLog({ user, occurredAt, dispatcherId }: UserDeletedEvent) {
