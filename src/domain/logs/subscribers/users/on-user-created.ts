...
export class OnUserCreated implements EventHandler {
  ...
  public setupSubscriptions(): void {
    DomainEvents.registerAggregateEvent(this.createLog.bind(this), UserCreatedEvent.name);
  }

  private async createLog({ user, occurredAt, dispatcherId }: UserCreatedEvent) {
