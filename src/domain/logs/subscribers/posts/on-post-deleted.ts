...
export class OnPostDeleted implements EventHandler {
  ...
  public setupSubscriptions(): void {
    DomainEvents.registerAggregateEvent(this.createLog.bind(this), PostDeletedEvent.name);
  }

  private async createLog({ post, occurredAt, dispatcherId }: PostDeletedEvent) {
